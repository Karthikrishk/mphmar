...
public class EmployeeDao {
   ...
   public void insertEmp(Employee emp) {
	   ...
	   try {
		...
		int noofrows = ps.executeUpdate();
		 System.out.println(noofrows + " inserted succesfully!!!");
  ...
  public void type_scroll_insensitive_rs()
	...
	public void batchUpdate()
	{
		...
		try {
			st=con.createStatement();
			st.addBatch("update mphemp set ename='karthi' where eid=2");
			st.addBatch("update mphemp set ename='vijay' where eid=3");
			st.addBatch("update mphemp set ename='ajith' where eid=4");
			st.addBatch("update mphemp set ename='kamal' where eid=5");
			st.addBatch("update mphemp set ename='surya' where eid=6");
