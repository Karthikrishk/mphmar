...
public class MainClass {
	...
	{ 
		...
		pw=br.readLine();
//	if(un.equals("karthi")&& pw.equals("pass"))
		
		BiPredicate<String,String> b1=(un1,pw1)->un1.equals("karthi")&& pw1.equals("pass");
		if(b1.test(un,pw))
		{
		try{
			...
			do
		{
			...
			System.out.println("11.RS scroll insensitive - insert");
			System.out.println("12.RS scroll insensitive - update");
